...
class InteractionLayer : Layer, KeyDownHandler {
    ...
    static let paddleLeft = Paddle(rect:Rect(size:Size(width:20, height:250)))
    static let paddleRight = Paddle(rect:Rect(size:Size(width:20, height:250)))
    static let paddletop = Paddle(rect:Rect(size:Size(width:300, height:20)))
    static let paddlebottom = Paddle(rect:Rect(size:Size(width:300, height:20)))
